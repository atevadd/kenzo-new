...
export default function TextSlider({ main_text, relative_text }) {
  ...
  return (
    <div
      data-scroll-section
      className={cn(style.slide, "w-screen bg-neutral-800 overflow-hidden")}
    >
      <div
        ref={containerRef}
        className={cn(style.slide_container, " relative")}
      >
        <p
          ref={textRef}
          className="font-semibold text-neutral-700 font-fira text-[82px] italic uppercase"
        >
        ...
        <p
          ref={secondTxtRef}
          className="top-0 absolute  left-full  font-semibold text-neutral-700 font-fira text-[82px] italic  uppercase pr-11"
        >
