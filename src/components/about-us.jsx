        ...
        <div className="inner-container w-full min-h-[70vh] grid grid-cols-2 gap-x-20">
          ...
          <div className="text-content h-full flex flex-col justify-between  w-[90%]">
            ...
            <div className="words text-white space-y-2">
              <StarggerText
                main_text={"see their"}
                className="header1 uppercase text-[84px] w-full text-left leading-[90%] "
              />
              <StarggerText
                main_text={"words"}
                className="header1 uppercase text-[84px] text-center w-full leading-[90%] italic"
              />
              <div className="w-full text-right  flex justify-end">
                <StarggerText
                  main_text={"about us"}
                  className="header1 uppercase text-[84px] w-auto text-right leading-[90%] hero_main-text hero_main-text-two"
                />
              </div>
            </div>
            ...
            <p className="typo-one text-xm mt-2 text-justify font-semibold w-full text-neutral-500 ">
              ...
              minus quidem, Lorem ipsum dolor sit amet consectetur adipisicing
              elit. Consequuntur, alias non. Et perferendis quo facilis placeat
              culpa, nihil velit cum, consequatur non est dignissimos odit enim
              sit. Facilis, ullam quibusdam? Et perferendis quo facilis placeat
              culpa, nihil velit cum, consequatur non est dignissimos odit enim
              sit. Facilis, ullam quibusdam?
            </p>
          </div>
          ...
          >
            ...
            <div className="w-full flex justify-between items-center text-white">
              ...
              <p className="date text-neutral-500">MAR 22, 2024</p>
            </div>
          </motion.div>
        </div>
      </section>
